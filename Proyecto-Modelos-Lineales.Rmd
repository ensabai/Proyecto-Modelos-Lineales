...
plot(x = aciertos_global$k, y = aciertos_global$aciertos_por, col = ifelse(aciertos_global$k == 51, "red", "black"))
...
```{r}
knn.1 <- knn(train.var, held.out.var, train.music_genre, k = 51)
(tabla.knn <- table(held.out.music_genre, knn.1))
aciertos <- 0
for (i in 1:nrow(tabla.knn)){
  aciertos <- aciertos + tabla.knn[i,i]
